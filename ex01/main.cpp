...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/01/20 14:03:09 by mmitkovi          #+#    #+#             */
/*   Updated: 2026/01/20 14:03:10 by mmitkovi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
...

	{
		...
		ptrDog->setIdea("Pointer Dog", 0);
		std::cout << "Dogs idea: " << ptrDog->getIdea(0) << std::endl;
		delete ptrDog;
	}
	{
		int size = 4;
